...
def frequency_penalty(K, coords, areas, members, member_types):
    ...
    try:
        ...
        if np.any(w2 < 0) or np.any(np.isnan(w2)):
            return 1e9
...
if __name__ == "__main__":
    ...
    plot_truss(node_coords, members, np.ones(len(members)), member_types,
               title="Initial Truss Structure (All Nodes and Members)",
               show_weights=False)
    ...
    output_path = "/home/sepehr/VS Code/Project/F- GA_LoadSet1_Freq.xlsx"
