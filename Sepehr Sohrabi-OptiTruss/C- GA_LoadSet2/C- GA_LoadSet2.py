...
def plot_truss(nodes, members, areas, member_types, title="Truss Structure", show_weights=True):
    ...
    # گره‌ها با رنگ‌ها و علائم مورد نظر
    ...
    ax.scatter(nodes[8:13, 0], nodes[8:13, 1], nodes[8:13, 2], color='#dfff00', s=50, marker='^', label='Load 1000 kg (Nodes 9-13)')  # لیمویی
    ax.scatter(nodes[13:26, 0], nodes[13:26, 1], nodes[13:26, 2], color='#40e0d0', s=50, marker='^', label='Load 300 kg (Nodes 14-26)')  # فیروزه‌ای
    ...
    # نیروی باد روی گره‌های 1 تا 37 (دایره توخالی قرمز)
...
if __name__ == "__main__":
    ...
    output_path = "/home/sepehr/VS Code/Project/C- GA_LoadSet2.xlsx"
